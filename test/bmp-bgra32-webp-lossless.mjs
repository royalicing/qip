...
const moduleUrl = new URL("../components/image/bmp/bmp-bgra32-to-webp-lossless.wasm", import.meta.url);
...
test("bmp-bgra32-to-webp-lossless emits VP8L and preserves transparent RGB exactly", async () => {
