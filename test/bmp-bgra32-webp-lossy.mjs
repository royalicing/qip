...
const modulePath = fileURLToPath(new URL("../components/image/bmp/bmp-bgra32-to-webp-lossy.wasm", import.meta.url));
...
test("bmp-bgra32-to-webp-lossy emits deterministic VP8 with bounded arena telemetry", async (t) => {
  try {
