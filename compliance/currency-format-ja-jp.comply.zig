// Content Compliance component: ja-JP currency formatting selected by ISO
...
// integer digits. The selected country currency supplies a CLDR-48 ja-JP
// prefix and fraction-digit count. Rounding is half away from zero. Invalid
// input traps.
const currency_data = @import("currency-format-ja-jp-table.zig");
