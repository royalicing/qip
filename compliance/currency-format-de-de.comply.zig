// Content Compliance component: de-DE currency formatting selected by ISO
...
// integer digits. The selected country currency supplies a CLDR-48 de-DE
// suffix and fraction-digit count. Rounding is half away from zero. Invalid
// input traps.
const currency_data = @import("currency-format-de-de-table.zig");
