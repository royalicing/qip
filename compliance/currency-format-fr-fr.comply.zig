// Content Compliance component: fr-FR currency formatting selected by ISO
...
// integer digits. The selected country currency supplies a CLDR-48 fr-FR
// suffix and fraction-digit count. Rounding is half away from zero. Invalid
// input traps.
const currency_data = @import("currency-format-fr-fr-table.zig");
