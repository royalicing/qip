...
const OUTPUT_KTX2 = @hasDecl(root, "JPEG_OUTPUT_KTX2") and root.JPEG_OUTPUT_KTX2;
...
pub fn input_bytes_cap() u32 {
    return @as(u32, @intCast(INPUT_CAP));
}

pub fn output_bytes_cap() u32 {
    return @as(u32, @intCast(OUTPUT_CAP));
}

pub fn input_content_type_ptr() u32 {
    return @as(u32, @intCast(@intFromPtr(INPUT_CONTENT_TYPE.ptr)));
}

pub fn input_content_type_size() u32 {
    return @as(u32, @intCast(INPUT_CONTENT_TYPE.len));
}

pub fn output_content_type_ptr() u32 {
    return @as(u32, @intCast(@intFromPtr(OUTPUT_CONTENT_TYPE.ptr)));
}

pub fn output_content_type_size() u32 {
...
fn decode(input: []const u8) JpegError!usize {
    ...
    const out_total = OUTPUT_HEADER_SIZE + out_stride * height;
...
pub fn render(input_size_in: u32) RenderResult {
    return .{
