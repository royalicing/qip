...
`bmp-to-webp-lossy-opaque.wasm` encodes photographs and other opaque BMPs as
...
Use `bmp-to-webp-lossy.wasm` when transparency must remain in the WebP. Use
`bmp-to-webp-lossless.wasm` when RGB values, including RGB beneath transparent
