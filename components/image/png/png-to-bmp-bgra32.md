...
`png-to-bmp-bgra32.wasm` converts non-interlaced, 8-bit PNG images to
bottom-up BGRA32 BMP. It accepts grayscale, grayscale-alpha, RGB, RGBA, and
...
`png-to-bmp-bgra32-simd.wasm` shares the parser, inflater, and batching policy
